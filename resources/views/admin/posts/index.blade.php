...
{ data: 'post_nr', name: 'post_nr' },
{ data: 'sender_sender', name: 'sender.sender' },
{ data: 'post_form_postform_sk', name: 'post_form.postform_sk' },
{ data: 'post_form.postform_sk', name: 'post_form.postform_sk' },
{ data: 'envelope', name: 'envelope', sortable: false, searchable: false },
