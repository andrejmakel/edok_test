            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-companyCatFirmas">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.firma.fields.company_cat') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.firma.fields.service_cat') }}
                                    </th>
                                    <th>
                                    ...
                                    <th>
                                        {{ trans('cruds.firma.fields.amount') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.firma.fields.kom_kom') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($firmas as $key => $firma)
                                    <tr data-entry-id="{{ $firma->id }}">
                                        ...
                                        <td>
                                            {{ $firma->company_cat->company_cat ?? '' }}
                                        </td>
                                        <td>
                                            {{ $firma->service_cat->service_cat ?? '' }}
                                        </td>
                                        <td>
...
@endcan
  ...
  let table = $('.datatable-companyCatFirmas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
