        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.postforms.update", [$postform->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('title_de') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_de" id="title_de" value="{{ old('title_de', $postform->title_de) }}">
                        ...
                        <div class="form-group {{ $errors->has('title_sk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_sk" id="title_sk" value="{{ old('title_sk', $postform->title_sk) }}">
                        ...
                        <div class="form-group {{ $errors->has('title_en') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_en" id="title_en" value="{{ old('title_en', $postform->title_en) }}">
