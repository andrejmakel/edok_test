            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-senderEPosts">
                            <thead>
                                <tr>
                                    <th width="10">
                            ...
                            <tbody>
                                @foreach($ePosts as $key => $ePost)
                                    <tr data-entry-id="{{ $ePost->id }}">
                                        ...
                                        <td>
                                            @can('e_post_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.e-posts.show', $ePost->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('e_post_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.e-posts.edit', $ePost->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('e_post_delete')
                                                <form action="{{ route('admin.e-posts.destroy', $ePost->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-senderEPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
