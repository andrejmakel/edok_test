                            ...
                            <tbody>
                                @foreach($calls as $key => $call)
                                    <tr data-entry-id="{{ $call->id }}">
                                        ...
                                        <td>
                                            @can('call_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.calls.show', $call->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('call_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.calls.edit', $call->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('call_delete')
                                                <form action="{{ route('admin.calls.destroy', $call->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
