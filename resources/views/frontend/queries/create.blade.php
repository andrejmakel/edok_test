                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.queries.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer_query" id="customer_query" value="{{ old('customer_query', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="long_text" id="long_text" value="{{ old('long_text', '') }}">
