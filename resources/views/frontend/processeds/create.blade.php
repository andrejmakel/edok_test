        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.processed.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.processeds.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="processed">{{ trans('cruds.processed.fields.processed') }}</label>
                            <input class="form-control" type="text" name="processed" id="processed" value="{{ old('processed', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="processed_de" id="processed_de" value="{{ old('processed_de', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="processed_en" id="processed_en" value="{{ old('processed_en', '') }}">
