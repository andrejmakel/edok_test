        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.spracovany.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.spracovanies.update", [$spracovany->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="popis">{{ trans('cruds.spracovany.fields.popis') }}</label>
                            <input class="form-control" type="text" name="popis" id="popis" value="{{ old('popis', $spracovany->popis) }}">
                            @if($errors->has('popis'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="popis_de" id="popis_de" value="{{ old('popis_de', $spracovany->popis_de) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="popis_en" id="popis_en" value="{{ old('popis_en', $spracovany->popis_en) }}">
