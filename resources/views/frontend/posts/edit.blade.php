                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.update", [$post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $post->date) }}" required>
                            @if($errors->has('date'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_nr" id="post_nr" value="{{ old('post_nr', $post->post_nr) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="post_form_id" id="post_form_id">
                                @foreach($post_forms as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('post_form_id') ? old('post_form_id') : $post->post_form->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="file_short_text" id="file_short_text" value="{{ old('file_short_text', $post->file_short_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="notice" id="notice">{!! old('notice', $post->notice) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="zadal_id" id="zadal_id">
                                @foreach($zadals as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('zadal_id') ? old('zadal_id') : $post->zadal->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('zadal'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="status_date" id="status_date" value="{{ old('status_date', $post->status_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="customer_query_id" id="customer_query_id">
                                @foreach($customer_queries as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('customer_query_id') ? old('customer_query_id') : $post->customer_query->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer_notice" id="customer_notice" value="{{ old('customer_notice', $post->customer_notice) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="processed_id" id="processed_id">
                                @foreach($processeds as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('processed_id') ? old('processed_id') : $post->processed->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="processed_at" id="processed_at" value="{{ old('processed_at', $post->processed_at) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="send_email" id="send_email" value="1" {{ $post->send_email || old('send_email', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="dok_typ_id" id="dok_typ_id">
                                @foreach($dok_typs as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('dok_typ_id') ? old('dok_typ_id') : $post->dok_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_info" id="payment_info" value="{{ old('payment_info', $post->payment_info) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $post->amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iban" id="iban" value="{{ old('iban', $post->iban) }}">
                            @if($errors->has('iban'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('iban') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="swift" id="swift" value="{{ old('swift', $post->swift) }}">
                            @if($errors->has('swift'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('swift') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vs" id="vs" value="{{ old('vs', $post->vs) }}">
                            @if($errors->has('vs'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vs') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ss" id="ss" value="{{ old('ss', $post->ss) }}">
                            @if($errors->has('ss'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ss') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ks" id="ks" value="{{ old('ks', $post->ks) }}">
                            @if($errors->has('ks'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ks') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="for_recipient" id="for_recipient" value="{{ old('for_recipient', $post->for_recipient) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="paid" id="paid" value="{{ old('paid', $post->paid) }}">
                            @if($errors->has('paid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('paid') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="due_date" id="due_date" value="{{ old('due_date', $post->due_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="reads[]" id="reads" multiple>
                                @foreach($reads as $id => $read)
                                    <option value="{{ $id }}" {{ (in_array($id, old('reads', [])) || $post->reads->contains($id)) ? 'selected' : '' }}>{{ $read }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('reads'))
                                <div class="invalid-feedback">
