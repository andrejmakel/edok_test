                    ...
                    <form method="POST" action="{{ route("frontend.uploads.update", [$upload->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="archive" id="archive" value="1" {{ $upload->archive || old('archive', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="closed" id="closed" value="1" {{ $upload->closed || old('closed', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $upload->date) }}" required>
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="reply" id="reply">{!! old('reply', $upload->reply) !!}</textarea>
                            @if($errors->has('reply'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('reply') }}
                                </div>
