        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.firma.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.firmas.update", [$firma->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="nasa_id" id="nasa_id">
                                @foreach($nasas as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('nasa_id') ? old('nasa_id') : $firma->nasa->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('nasa'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nazov" id="nazov" value="{{ old('nazov', $firma->nazov) }}">
                            @if($errors->has('nazov'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nazov') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="activ" id="activ" value="1" {{ $firma->activ || old('activ', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="team_id" id="team_id">
                                @foreach($teams as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('team_id') ? old('team_id') : $firma->team->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('team'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="kontakts[]" id="kontakts" multiple>
                                @foreach($kontakts as $id => $kontakt)
                                    <option value="{{ $id }}" {{ (in_array($id, old('kontakts', [])) || $firma->kontakts->contains($id)) ? 'selected' : '' }}>{{ $kontakt }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="idmmc" id="idmmc" value="{{ old('idmmc', $firma->idmmc) }}">
                            @if($errors->has('idmmc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('idmmc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_pohoda" id="id_pohoda" value="{{ old('id_pohoda', $firma->id_pohoda) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $firma->address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_address" id="short_address" value="{{ old('short_address', $firma->short_address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ico" id="ico" value="{{ old('ico', $firma->ico) }}">
                            @if($errors->has('ico'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ico') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dic" id="dic" value="{{ old('dic', $firma->dic) }}">
                            @if($errors->has('dic'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ic_dph" id="ic_dph" value="{{ old('ic_dph', $firma->ic_dph) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ic_dph_form" id="ic_dph_form" value="{{ old('ic_dph_form', $firma->ic_dph_form) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefon" id="telefon" value="{{ old('telefon', $firma->telefon) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="e_schranka_id" id="e_schranka_id">
                                @foreach($e_schrankas as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('e_schranka_id') ? old('e_schranka_id') : $firma->e_schranka->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="spracovanie_id" id="spracovanie_id">
                                @foreach($spracovanies as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('spracovanie_id') ? old('spracovanie_id') : $firma->spracovanie->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sprac_posty" id="sprac_posty" value="{{ old('sprac_posty', $firma->sprac_posty) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ucto_id" id="ucto_id">
                                @foreach($uctos as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('ucto_id') ? old('ucto_id') : $firma->ucto->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('ucto'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bank_id" id="bank_id">
                                @foreach($banks as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bank_id') ? old('bank_id') : $firma->bank->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('bank'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iban" id="iban" value="{{ old('iban', $firma->iban) }}">
                            @if($errors->has('iban'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('iban') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="swift_bic" id="swift_bic" value="{{ old('swift_bic', $firma->swift_bic) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="popis" id="popis">{!! old('popis', $firma->popis) !!}</textarea>
                            @if($errors->has('popis'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('popis') }}
                                </div>
