        ...
        <div class="col-md-12">
            @can('firma_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.firmas.create') }}">
                            ...
                            <tbody>
                                @foreach($firmas as $key => $firma)
                                    <tr data-entry-id="{{ $firma->id }}">
                                        ...
                                        <td>
                                            @can('firma_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.firmas.show', $firma->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('firma_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.firmas.edit', $firma->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('firma_delete')
                                                <form action="{{ route('frontend.firmas.destroy', $firma->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('firma_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.firmas.massDestroy') }}",
