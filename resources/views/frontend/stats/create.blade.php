        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.stat.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.stats.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="stat_sk">{{ trans('cruds.stat.fields.stat_sk') }}</label>
                            <input class="form-control" type="text" name="stat_sk" id="stat_sk" value="{{ old('stat_sk', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="stat_de" id="stat_de" value="{{ old('stat_de', '') }}">
