...
class OutgoingPostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.outgoingPosts.index', compact('outgoingPosts', 'recipients', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.outgoingPosts.create', compact('recipients', 'teams'));
    }
    ...
    public function store(StoreOutgoingPostRequest $request)
    {
        ...
        return redirect()->route('admin.outgoing-posts.index');
    }
    ...
    public function edit(OutgoingPost $outgoingPost)
    {
        ...
        return view('admin.outgoingPosts.edit', compact('outgoingPost', 'recipients', 'teams'));
    }
    ...
    public function show(OutgoingPost $outgoingPost)
    {
        ...
        return view('admin.outgoingPosts.show', compact('outgoingPost'));
    }
