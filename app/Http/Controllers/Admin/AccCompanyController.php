...
class AccCompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.accCompanies.index', compact('accCompanies'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.accCompanies.create');
    }
    ...
    public function store(StoreAccCompanyRequest $request)
    {
        ...
        return redirect()->route('admin.acc-companies.index');
    }
    ...
    public function edit(AccCompany $accCompany)
    {
        ...
        return view('admin.accCompanies.edit', compact('accCompany'));
    }
    ...
    public function show(AccCompany $accCompany)
    {
        ...
        return view('admin.accCompanies.show', compact('accCompany'));
    }
