...
class SpracovanieController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.spracovanies.index', compact('spracovanies'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.spracovanies.create');
    }
    ...
    public function store(StoreSpracovanyRequest $request)
    {
        ...
        return redirect()->route('admin.spracovanies.index');
    }
    ...
    public function edit(Spracovany $spracovany)
    {
        ...
        return view('admin.spracovanies.edit', compact('spracovany'));
    }
    ...
    public function show(Spracovany $spracovany)
    {
        ...
        return view('admin.spracovanies.show', compact('spracovany'));
    }
