...
class FirmaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.firmas.index', compact('banks', 'e_schrankas', 'firmas', 'nasas', 'spracovanies', 'teams', 'uctos', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.firmas.create', compact('banks', 'e_schrankas', 'kontakts', 'nasas', 'spracovanies', 'teams', 'uctos'));
    }
    ...
    public function store(StoreFirmaRequest $request)
    {
        ...
        return redirect()->route('admin.firmas.index');
    }
    ...
    public function edit(Firma $firma)
    {
        ...
        return view('admin.firmas.edit', compact('banks', 'e_schrankas', 'firma', 'kontakts', 'nasas', 'spracovanies', 'teams', 'uctos'));
    }
    ...
    public function show(Firma $firma)
    {
        ...
        return view('admin.firmas.show', compact('firma'));
    }
