...
class ProcessedController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.processeds.index', compact('processeds'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.processeds.create');
    }
    ...
    public function store(StoreProcessedRequest $request)
    {
        ...
        return redirect()->route('frontend.processeds.index');
    }
    ...
    public function edit(Processed $processed)
    {
        ...
        return view('frontend.processeds.edit', compact('processed'));
    }
    ...
    public function show(Processed $processed)
    {
        ...
        return view('frontend.processeds.show', compact('processed'));
    }
