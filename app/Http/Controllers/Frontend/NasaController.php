...
class NasaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.nasas.index', compact('nasas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.nasas.create');
    }
    ...
    public function store(StoreNasaRequest $request)
    {
        ...
        return redirect()->route('frontend.nasas.index');
    }
    ...
    public function edit(Nasa $nasa)
    {
        ...
        return view('frontend.nasas.edit', compact('nasa'));
    }
    ...
    public function show(Nasa $nasa)
    {
        ...
        return view('frontend.nasas.show', compact('nasa'));
    }
