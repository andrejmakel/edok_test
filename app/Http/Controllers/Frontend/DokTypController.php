...
class DokTypController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dokTyps.index', compact('dokTyps'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dokTyps.create');
    }
    ...
    public function store(StoreDokTypRequest $request)
    {
        ...
        return redirect()->route('frontend.dok-typs.index');
    }
    ...
    public function edit(DokTyp $dokTyp)
    {
        ...
        return view('frontend.dokTyps.edit', compact('dokTyp'));
    }
    ...
    public function show(DokTyp $dokTyp)
    {
        ...
        return view('frontend.dokTyps.show', compact('dokTyp'));
    }
