...
class PostformController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.postforms.index', compact('postforms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.postforms.create');
    }
    ...
    public function store(StorePostformRequest $request)
    {
        ...
        return redirect()->route('frontend.postforms.index');
    }
    ...
    public function edit(Postform $postform)
    {
        ...
        return view('frontend.postforms.edit', compact('postform'));
    }
    ...
    public function show(Postform $postform)
    {
        ...
        return view('frontend.postforms.show', compact('postform'));
    }
