...
class InvoicesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.invoices.index', compact('invoice_typs', 'invoices', 'nasas', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.invoices.create', compact('nasas', 'teams', 'typs'));
    }
    ...
    public function edit(Invoice $invoice)
    {
        ...
        return view('frontend.invoices.edit', compact('invoice', 'nasas', 'teams', 'typs'));
    }
