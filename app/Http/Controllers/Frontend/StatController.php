...
class StatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.stats.index', compact('stats'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.stats.create');
    }
    ...
    public function store(StoreStatRequest $request)
    {
        ...
        return redirect()->route('frontend.stats.index');
    }
    ...
    public function edit(Stat $stat)
    {
        ...
        return view('frontend.stats.edit', compact('stat'));
    }
    ...
    public function show(Stat $stat)
    {
        ...
        return view('frontend.stats.show', compact('stat'));
    }
