...
class UploadController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.uploads.index', compact('teams', 'uploads'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.uploads.create', compact('teams'));
    }
    ...
    public function edit(Upload $upload)
    {
        ...
        return view('frontend.uploads.edit', compact('teams', 'upload'));
    }
