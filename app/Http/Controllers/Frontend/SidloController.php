...
class SidloController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.sidlos.index', compact('sidlos'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sidlos.create');
    }
    ...
    public function store(StoreSidloRequest $request)
    {
        ...
        return redirect()->route('frontend.sidlos.index');
    }
    ...
    public function edit(Sidlo $sidlo)
    {
        ...
        return view('frontend.sidlos.edit', compact('sidlo'));
    }
    ...
    public function show(Sidlo $sidlo)
    {
        ...
        return view('frontend.sidlos.show', compact('sidlo'));
    }
