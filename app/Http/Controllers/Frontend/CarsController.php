...
class CarsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.cars.index', compact('cars', 'insurances', 'teams', 'typs', 'znackas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.cars.create', compact('kasko_poistovnas', 'pzp_poistovnas', 'teams', 'typs', 'znackas'));
    }
    ...
    public function edit(Car $car)
    {
        ...
        return view('frontend.cars.edit', compact('car', 'kasko_poistovnas', 'pzp_poistovnas', 'teams', 'typs', 'znackas'));
    }
